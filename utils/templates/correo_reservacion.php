                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">                                            
                                            <p align="justify">
                                                Tu reservaci&oacute;n  se realiz&oacute; exitosamente con fecha <b><?php echo $fecha; ?></b>, no olvides hacer registrar tu <b>SALIDA</b> de la terraza para poder seguir reservando un lugar.
                                                <br />                                           
                                                <br />                                           
                                                <br />                                           
                                                <br />                                                                                           
