...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'dirac.jpg')) {
		$tcpdf_header_logo = 'dirac.jpg';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'FIGG');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'FIGG');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Recibo de Nómina');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Arjion - www.arjion.com");
}
